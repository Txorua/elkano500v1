<div id="slideshow" class="fullwidthbanner-container main-slider hidden-xs">
    ...
    <div class="fullwidthbanner">
        ...
        <?php foreach ($rows as $id => $row) { ?>
            ...
            $image = image_style_url('slideshow', $node->field_slideshow_entry_image[$lang][0]['uri']); 
            $title = $node->field_slideshow_entry_image[$lang][0]['title'];
            $alt = $node->field_slideshow_entry_image[$lang][0]['alt'];
            
            if ($node->type=='slideshow_entry') {  ?>
                ...
                <?php } ?>
                    ...
                    data-easing="Power0.easeIn">
                        ...
                        <?php if ($node->field_slideshow_teaser_text): ?>
                        <?php $field_teaser_text = $node->field_slideshow_teaser_text[$lang][0]['value']; ?>
...
<?php
$rs_effect_time = 5000;//(int) theme_get_setting('rs_slideshow_full_effect_time')*1000;
